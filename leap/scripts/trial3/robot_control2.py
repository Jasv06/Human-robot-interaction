...
def main():
   ...
   while not rospy.is_shutdown():
      ...
      #print("ROBOT POSITIONM",robot_position)
      #and robot_position == [0,0,0,0,0] 
      if hand_status > 0.5 and hand_status <= 1 and hand_life >= 4 and robot_position == [0,0,0,0,0] or number_of_hands == 0 and robot_position == [0,0,0,0,0]:
      ...
      if hand_status < 0.5 and hand_life >= 4 and robot_position == [0,0,0,0,0]:
